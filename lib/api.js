...
export async function requestSamplesBulk({
  supplierProductIds, specColore = null, specLavorazione = null, specRefrigerato = false,
  specSo2 = null, specGrado = null, specVarieta = null, message = null,
  shippingAddress = null, quantityL = null,
}) {
  const payload = {
    ...
    spec_grado_potenziale: specGrado ?? null,
  ...
  if (error) throw error; // errori globali (NOT_AUTHENTICATED, INDIRIZZO_MANCANTE, ...)
  return data || [];
}

// Traduzione degli errori GLOBALI della RPC (quando data è null).
const BULK_SAMPLE_ERRORS = {
  NOT_AUTHENTICATED: "Devi accedere per richiedere una campionatura.",
  NESSUN_FORNITORE_SELEZIONATO: "Seleziona almeno un fornitore.",
  INDIRIZZO_MANCANTE: "Completa l'indirizzo della tua azienda nel profilo prima di richiedere una campionatura.",
