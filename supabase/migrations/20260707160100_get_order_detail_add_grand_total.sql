-- Aggiunge grand_total (total_amount + service charges, es. "Costi di servizio
-- escrow" €0,35) e l'elenco service_charges al dettaglio ordine, così il totale
-- mostrato al cliente include sempre le voci accessorie.
