...
function BSIcon({ size = 56, uid = "a" }) {
  ...
  return (
    <svg width={size} height={size} viewBox="0 0 56 56" fill="none" xmlns="http://www.w3.org/2000/svg">
      ...
      <path
        d="M42 12 L42 34"
        stroke={`url(#${arr})`} strokeWidth="3.5" strokeLinecap="round"
      />
      <path
        d="M35.5 28.5 L42 38 L48.5 28.5"
        stroke={`url(#${arr})`} strokeWidth="3.5" strokeLinecap="round" strokeLinejoin="round" fill="none"
      />
    </svg>
  );
}
